...
import com.study.es.entity.Article;
...
public class JestExample {
    ...
    private static JestClient getJestClient() {
        ...
        String connectionUrl = "http://192.168.232.132:9200";
    ...
    public void deleteIndex() throws Exception {
        ...
        DeleteIndex deleteIndex = new DeleteIndex.Builder(Article.INDEX).build();
    ...
    public void createIndex() throws Exception {
        ...
        Index index1 = new Index.Builder(article1).index(Article.INDEX).type(Article.TYPE).build();
        Index index2 = new Index.Builder(article2).index(Article.INDEX).type(Article.TYPE).build();
        Index index3 = new Index.Builder(article3).index(Article.INDEX).type(Article.TYPE).build();
     ...
     * @throws Exception
     */
    private static void getDocument(String id) throws Exception {
        JestClient jestClient = JestExample.getJestClient();
        Get get = new Get.Builder(Article.INDEX, id).type(Article.TYPE).build();
    ...
    private static void deleteDocument(String id) throws Exception {
        JestClient jestClient = JestExample.getJestClient();
        Delete delete = new Delete.Builder(id).index(Article.INDEX).type(Article.TYPE).build();
